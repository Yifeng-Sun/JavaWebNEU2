...
<head>
    ...
    <script type="text/javascript">
        ...
        function edit() {
            ...
            objToSend1.title = document.getElementById("title1").value;
            objToSend1.pSummary = document.getElementById("summary1").value;
            objToSend1.pDesc = document.getElementById("Des1").value;
            objToSend1.pType = document.getElementById("type1").value;
            objToSend1.pHyperlink = document.getElementById("HL1").value;

            objToSend1.title = document.getElementById("title2").value;
            objToSend1.pSummary = document.getElementById("summary2").value;
            objToSend1.pDesc = document.getElementById("Des2").value;
            objToSend1.pType = document.getElementById("type2").value;
            objToSend1.pHyperlink = document.getElementById("HL2").value;

            objToSend1.title = document.getElementById("title3").value;
            objToSend1.pSummary = document.getElementById("summary3").value;
            objToSend1.pDesc = document.getElementById("Des3").value;
            objToSend1.pType = document.getElementById("type3").value;
            objToSend1.pHyperlink = document.getElementById("HL3").value;
            // console.log(objToSend1);

            var objList = {objToSend1,objToSend2,objToSend3};
            var jsonString = JSON.stringify(objList);
            console.log(jsonString);
            function sendInfo(jsonString) {
                $.ajax({
                    url:"/handleEdit" , // 请求路径
                    type:"POST" , //请求方式
        ...
        $(function () {
            ...
            $.getJSON("../tutorial3/project1.json", function(json) {
                ...
                document.getElementById("title1").value = jsonObj1.pTitle;
                document.getElementById("summary1").value = jsonObj1.pSummary;
                document.getElementById("Des1").value = jsonObj1.pDesc;
                document.getElementById("type1").value = jsonObj1.pType;
                document.getElementById("HL1").value = jsonObj1.pHyperlink;
            });
            $.getJSON("../tutorial3/project2.json", function(json) {
                // console.log(json); // this will show the info it in console
                jsonObj2 = json;
                // console.log(jsonObj1.pDesc);
                document.getElementById("title2").value = jsonObj2.pTitle;
                document.getElementById("summary2").value = jsonObj2.pSummary;
                document.getElementById("Des2").value = jsonObj2.pDesc;
                document.getElementById("type2").value = jsonObj2.pType;
                document.getElementById("HL2").value = jsonObj2.pHyperlink;
            });
            $.getJSON("../tutorial3/project3.json", function(json) {
                // console.log(json); // this will show the info it in console
                jsonObj3 = json;
                // console.log(jsonObj1.pDesc);
                document.getElementById("title3").value = jsonObj3.pTitle;
                document.getElementById("summary3").value = jsonObj3.pSummary;
                document.getElementById("Des3").value = jsonObj3.pDesc;
                document.getElementById("type3").value = jsonObj3.pType;
                document.getElementById("HL3").value = jsonObj3.pHyperlink;
            });
...
<%--    </div>--%>
    <div style="width: 90%">
        <form action="form_action.asp" method="get">
            Title: <br><input type="text" id="title1"/><br>
            Summary: <br><input type="text" id="summary1"/><br>
            Description: <br><input type="text" id="Des1"/><br>
            Type: <br><input type="text" id="type1"/><br>
            Hyperlink: <br><input type="text" id="HL1"/><br>
        </form>
    </div>

<%--        <div class="detailBox pTitle"><span>Title</span></div><br>--%>
<%--        <div class="detailBox pSummary"><span>Summary</span></div><br>--%>
<%--        <div class="detailBox pDesc"><span>Description</span></div><br>--%>
<%--        <div class="detailBox pType"><span>Type</span></div><br>--%>
<%--    <div class="detailBox pHyperlink"><span>Hyperlink</span></div>--%>
...
<div class="bigBox clickToLoad" id="2">
    ...
    <div style="width: 90%">
        <form action="form_action.asp" method="get">
            Title: <br><input type="text" id="title2"/><br>
            Summary: <br><input type="text" id="summary2"/><br>
            Description: <br><input type="text" id="Des2"/><br>
            Type: <br><input type="text" id="type2"/><br>
            Hyperlink: <br><input type="text" id="HL2"/><br>
        </form>
    </div>
...
<div class="bigBox clickToLoad" id="3">
    ...
    <div style="width: 90%">
        <form action="form_action.asp" method="get">
            Title: <br><input type="text" id="title3" /><br>
            Summary: <br><input type="text" id="summary3"/><br>
            Description: <br><input type="text" id="Des3"/><br>
            Type: <br><input type="text" id="type3"/><br>
            Hyperlink: <br><input type="text" id="HL3"/><br>
        </form>
    </div>
...
<div class="addBoxBox clickToLoad" id="editBtn">
    <div>Edit</div>
</div>
